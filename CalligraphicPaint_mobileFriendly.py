...
actionBar.add_command(label = "Close", command = mainWindow.destroy)
mainWindow.config(menu = actionBar)

brushSizeScale = Scale(mainWindow, variable = brushSize, from_ = 3.0, to = 8.0, orient = "horizontal", length = canvasWidth, tickinterval = 1, resolution = 0.1)
brushSizeScale.pack()

mobileSwipeMessage = Label(text = 'Swipe slowly, this program \n was  originally designed for desktop computers')
mobileSwipeMessage.pack()
